...
/**
 * Jackson 3 port of {@link OAuth2ExceptionJackson2Deserializer}: deserializes the RFC 6749 error response
 * format into the matching {@link OAuth2Exception} subclass.
 */
public class OAuth2ExceptionJackson3Deserializer extends StdDeserializer<OAuth2Exception> {

	public OAuth2ExceptionJackson3Deserializer() {
